...
```text
dist/QuietType-1.0.0-rc.8-macOS-arm64.dmg
dist/QuietType-1.0.0-rc.8-macOS-arm64.dmg.sha256
```
...
```bash
bash scripts/validate-release-artifact.sh dist/QuietType-1.0.0-rc.8-macOS-arm64.dmg
```
...
```bash
QUIETTYPE_VALIDATE_LAUNCH=1 bash scripts/validate-release-artifact.sh dist/QuietType-1.0.0-rc.8-macOS-arm64.dmg
```
...
```bash
VERSION="v1.0.0-rc.8"
DMG="dist/QuietType-1.0.0-rc.8-macOS-arm64.dmg"

git tag -a "$VERSION" -m "QuietType 1.0.0 RC8"
