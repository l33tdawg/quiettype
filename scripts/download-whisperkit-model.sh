...
TOKENIZER_REPO="${QUIETTYPE_WHISPER_TOKENIZER_REPO:-openai/whisper-large-v3}"
TOKENIZER_REVISION="${QUIETTYPE_WHISPER_TOKENIZER_REVISION:-06f233fe06e710322aca913c1bc4249a0d71fce1}"
...
python3 - "$TOKENIZER_REPO" "$TOKENIZER_REVISION" "$MODEL_DIR" <<'PY'
import sys
from huggingface_hub import snapshot_download
